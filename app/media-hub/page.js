                ...
                <div className="flex flex-col gap-4">
                  {route.steps.map((step, idx) => (
                    <div key={idx} className="flex gap-4 items-start">
                      <div className="w-8 h-8 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center shrink-0 text-sm font-extrabold text-slate-400">
                        {idx + 1}
                      </div>
