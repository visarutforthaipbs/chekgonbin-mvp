      ...
      <div className="container mx-auto px-4 md:px-6 py-12 flex flex-col gap-12 max-w-3xl">
        ...
        <section className="bg-white border border-slate-200 rounded-[2.5rem] p-8 md:p-12 shadow-sm flex flex-col gap-8">
          ...
          <div className="p-6 bg-orange-50 border-l-4 border-signal-orange rounded-r-2xl flex gap-4">
            <AlertTriangle className="text-signal-orange shrink-0 mt-1" size={24} />
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-[2.5rem] p-8 flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <h4 className="font-extrabold text-slate-800">การเก็บรักษาข้อมูล</h4>
              ...
              <div className="flex flex-col gap-2">
                <h4 className="font-extrabold text-slate-800">การใช้ข้อมูล</h4>
