  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 flex flex-col items-center">
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 flex flex-col gap-12 max-w-3xl">
        ...
        <section className="bg-white border border-slate-200 rounded-[2.5rem] p-8 md:p-12 shadow-sm flex flex-col gap-8">
          ...
          <div className="p-6 bg-orange-50 border-l-4 border-signal-orange rounded-r-2xl flex gap-4">
            <AlertTriangle className="text-signal-orange shrink-0 mt-1" size={24} aria-hidden="true" />
        ...
        <section className="flex flex-col gap-10">
          <div className="flex flex-col gap-6">
            <h2 className="text-2xl font-extrabold text-slate-900">วิธีการทำงาน</h2>
            <p className="text-slate-600">ระบบจะตรวจสอบข้อมูลที่คุณกรอกโดยเปรียบเทียบกับ 3 แหล่งข้อมูลหลัก:</p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { icon: CheckCircle2, color: "text-signal-green", label: "Whitelist", desc: "บริษัทจัดหางานถูกกฎหมาย" },
                ...
                <div key={idx} className="p-6 bg-white border border-slate-100 rounded-[2rem] shadow-sm flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-6">
            <h2 className="text-2xl font-extrabold text-slate-900">นโยบายความเป็นส่วนตัว (PDPA)</h2>
            <div className="bg-slate-50 border border-slate-200 rounded-[2.5rem] p-8 flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <h3 className="font-extrabold text-slate-800">การเก็บรักษาข้อมูล</h3>
              ...
              <div className="flex flex-col gap-2">
                <h3 className="font-extrabold text-slate-800">การใช้ข้อมูล</h3>
          ...
          <div className="flex flex-col gap-6">
            <h2 className="text-2xl font-extrabold text-slate-900">ช่องทางติดต่อ</h2>
            <div className="flex flex-wrap gap-4">
              <a href="mailto:thaimigrantwatchs@gmail.com" className="flex items-center gap-3 px-6 py-4 bg-white border border-slate-200 rounded-[2rem] hover:border-brand-primary transition-all group">
                <Mail className="text-slate-400 group-hover:text-brand-primary" size={20} aria-hidden="true" />
                <span className="text-slate-700 font-medium">Email ติดต่อโครงการ</span>
              </a>
              <a href="https://www.facebook.com/profile.php?id=61570127262236" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-6 py-4 bg-white border border-slate-200 rounded-[2rem] hover:border-brand-primary transition-all group">
                <Users className="text-slate-400 group-hover:text-brand-primary" size={20} aria-hidden="true" />
        ...
        <footer className="mt-8 p-8 bg-brand-primary/5 border border-brand-primary/10 rounded-[2rem] text-center">
          <p className="text-brand-primary font-extrabold text-sm uppercase tracking-widest">
